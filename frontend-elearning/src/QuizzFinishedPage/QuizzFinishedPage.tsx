        ...
        <div>
            <div className={`${styles["page"]}`}>
                <div className={`${styles["div--description__principal"]}`}>
                    <span className={`${styles["text--title"]}`}>{quizInfo.courseTitle}</span>
                ...
                <div className={`${styles["div--incapsulation"]}`}>
                    <div className={`${styles["div--description"]}`}>
                        <span className={`${styles["text--subtitle__principal"]}`}>Quiz title: {quizInfo.quizzTitle} </span>
                        <span className={`${styles["text--normal"]}`}>Duration: {quizInfo.durationQuiz} minutes</span>
                        <span className={`${styles["text--normal"]}`}>Closed: {quizInfo.endDateQuiz}</span>
                    </div>
                    <div className={`${styles["div--must-description"]}`}>
                        ...
                        <div className={`${styles["div--dynamic-info"]}`}>
                            ...
                            <div className={`${styles["div--dynamic-table_down"]}`}>
                                ...
                                <li className={`${styles["three"]}`}>{quizInfo.isQuizEnded==0?"Not permitted":  <Button text='Review your test!' func={() => { console.log("Quizz revied!") }} type='1' />}</li>
                            </div>
            ...
            <Footer courseTitle={quizInfo.courseTitle} sectionTitle={quizInfo.sectionTitle} quizzTitle={quizInfo.quizzTitle} />
        </div>
    )
}
